...
def hyperTuningCBOW(hidden_dim,embedding_dim,learning_rate,dropout_prob,legendCBOW,iteratingParam):
    ...
    legendCBOW[iteratingParam][hidden_dim] = training_loop(model, loss, optimizer, training_iter, dev_iter, train_eval_iter)
...
for h in range(5,6,5):#20
    hyperTuningCBOW(h,embedding_dim,learning_rate,dropout_prob,legendCBOW,'hidden_dim')
    pp.pprint(legendCBOW)
print("iterating embedding_dim CBOW")
for e in range(50,51,50):#300
    hyperTuningCBOW(hidden_dim,e,learning_rate,dropout_prob,legendCBOW,'embedding_dim')
    pp.pprint(legendCBOW)
print("iterating learning_rate CBOW")
for l in [0.001]:# np.linspace(0.0001, 0.001, num=10, endpoint=True):
    hyperTuningCBOW(hidden_dim,embedding_dim,l,dropout_prob,legendCBOW,'learning_rate')
    pp.pprint(legendCBOW)
print("iterating dropout_prob CBOW")
for d in [0.5]: #np.linspace(0.1, 0.9, num=9, endpoint=True):
    hyperTuningCBOW(hidden_dim,embedding_dim,learning_rate,d,legendCBOW,'dropout_prob')
    pp.pprint(legendCBOW)
...
def hyperTuningCNN(window_size,n_filters,embedding_dim,learning_rate,dropout_prob,legendCNN,iteratingParam):
    ...
    train_eval_iter = eval_iter(training_set[0:500], batch_size)
    dev_iter = eval_iter(dev_set[0:500], batch_size)
    legendCNN[iteratingParam][hidden_dim] = training_loop(cnn_model, loss, optimizer, training_iter, dev_iter, train_eval_iter)
...
for w in [5]:#range(1,11):
    hyperTuningCNN(w,n_filters,embedding_dim,learning_rate,dropout_prob,legendCNN,'window_size')
    pp.pprint(legendCNN)
print("iterating n_filters CNN")
for n in [10]:#range(10,21):
    hyperTuningCNN(window_size,n,embedding_dim,learning_rate,dropout_prob,legendCNN,'n_filters')
    pp.pprint(legendCNN)
print("iterating embedding_dim CNN")
for e in [50]:#range(50,300,50):
    hyperTuningCNN(window_size,n_filters,e,learning_rate,dropout_prob,legendCNN,'embedding_dim')
    pp.pprint(legendCNN)
print("iterating learning_rate CNN")
for l in [0.001]:#np.linspace(0.0001, 0.001, num=10, endpoint=True):
    hyperTuningCNN(window_size,n_filters,embedding_dim,l,dropout_prob,legendCNN,'learning_rate')
    pp.pprint(legendCNN)
print("iterating dropout_prob CNN")
for d in [0.5]:#np.linspace(0.1, 0.9, num=9, endpoint=True):
    hyperTuningCNN(window_size,n_filters,embedding_dim,learning_rate,d,legendCNN,'dropout_prob')
    pp.pprint(legendCNN)
